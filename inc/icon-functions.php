...
function humescores_get_svg( $args = array() ) {
	...
	/*
	 * Humescores doesn't use the SVG title or description attributes; non-decorative icons are described with .screen-reader-text.
	 *
 ...
 */
function humescores_dropdown_icon_to_menu_link( $title, $item, $args, $depth ) {
	if ( 'top' === $args->theme_location ) {
		foreach ( $item->classes as $value ) {
			if ( 'menu-item-has-children' === $value || 'page_item_has_children' === $value ) {
				$title = $title . humescores_get_svg( array( 'icon' => 'angle-down' ) );
			}
		}
	}
...
add_filter( 'nav_menu_item_title', 'humescores_dropdown_icon_to_menu_link', 10, 4 );
...
function humescores_social_links_icons() {
	...
	/**
	 * Filter Humescores social links icons.
	 *
